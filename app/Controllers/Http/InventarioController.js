...
class InventarioController {
  ...
  async index ({ request, response, view }) {
    let inventario = await Inventario.query().with('ferreteriaProducto').fetch()
  ...
  async store ({ request, response }) {
    ...
    return response.json('cantidad aumentada en el stock, añadido');
  }
  ...
  async update ({ params, request, response }) {
    ...
    return response.json('Inventario correctamente editado');
  }
  ...
  async destroy ({ params, request, response }) {
    ...
    return response.json('Producto ha sido eliminado');
  }
}
