...
class ProductoController {
  ...
  async create ({ request, response, view }) {
    ...
    return view.render('ferreteriaProducto.create', { producto: producto.toJSON() });
  }
  ...
  async store ({ request, response }) {
    ...
    return response.json('Producto ha sido creado');
  }
  ...
  async edit ({ params, request, response, view }) {
    ...
    return view.render('ferreteriaProducto.edit', { producto: producto.toJSON() });
  }
  ...
  async update ({ params, request, response }) {
    ...
    await producto.save();
    return response.json('Producto ha sido editado');
  }
